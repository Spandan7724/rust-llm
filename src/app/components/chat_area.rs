...
const USER_MESSAGE_DARK_MODE_COLORS: &str  = "bg-teal-400 text-white";
const USER_MESSAGE_LIGHT_MODE_COLORS: &str  = "bg-teal-400 text-white";
...
const CHAT_AREA_LIGHT_MODE_COLORS: &str = "border-gray-50 bg-gray-100";
const CHAT_AREA_DARK_MODE_COLORS: &str = "border-gray-50 bg-zinc-950";
